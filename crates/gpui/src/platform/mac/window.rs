    ...
    pub fn open(
        ...
        unsafe {
            ...
            if let Some(has_shadow) = has_shadow {
                native_window.setHasShadow_(has_shadow as BOOL);
            }
...
impl PlatformWindow for MacWindow {
            ...
            .spawn(async move {
                unsafe {
                    ...
                    let ns_origin = NSPoint::new(
                        (screen_frame.origin.x as f32 + origin.x.0) as f64,
                        (screen_frame.size.height as f32 + screen_frame.origin.y as f32
                            - origin.y.0
                            - frame.size.height as f32) as f64,
                    );
                    let _: () = msg_send![window, setFrameOrigin: ns_origin];
                }
            })
            .detach();
    }
    ...
    fn set_has_shadow(&self, has_shadow: bool) {
        ...
        this.foreground_executor
            .spawn(async move {
                unsafe {
                    let _: () = msg_send![window, setHasShadow: has_shadow as BOOL];
                }
            })
            .detach();
    }
    ...
    fn set_background_appearance(&self, background_appearance: WindowBackgroundAppearance) {
        ...
        unsafe {
            ...
            let background_color = if opaque {
                ...
                NSColor::colorWithSRGBRed_green_blue_alpha_(nil, 0f64, 0f64, 0f64, 0.0)
            };
