...
typedef enum BackdropBlurInputIndex {
  BackdropBlurInputIndex_Vertices = 0,
  BackdropBlurInputIndex_Blurs = 1,
  BackdropBlurInputIndex_ViewportSize = 2,
  BackdropBlurInputIndex_BackdropTexture = 3,
} BackdropBlurInputIndex;

typedef enum BackdropBlurPassInputIndex {
  BackdropBlurPassInputIndex_Vertices = 0,
  BackdropBlurPassInputIndex_Params = 1,
  BackdropBlurPassInputIndex_SourceTexture = 2,
} BackdropBlurPassInputIndex;
...
typedef struct BackdropBlurParams {
  struct Size_DevicePixels input_size;
  float offset;
  float pad;
} BackdropBlurParams;
